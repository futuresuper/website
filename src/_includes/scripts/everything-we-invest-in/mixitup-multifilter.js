!(function (u) {
  ...
  var e = function (u) {
    ...
    if (
      ...
      !u.CORE_VERSION ||
        !i.compareVersions(e.REQUIRE_CORE_VERSION, u.CORE_VERSION))
    )
      throw new Error(
    ...
    u.ConfigCallbacks.registerAction(
      "afterConstruct",
      "multifilter",
      function () {
      ...
      i.extend(u.FilterGroup.prototype, {
        init: function (u, e) {
          ...
          (t.dom.el = u),
            ...
            (t.mixer = e),
            ((i && "and" === i.toLowerCase()) ||
              "and" === e.config.multifilter.logicWithinGroup) &&
              (t.logic = "and"),
            t.bindEvents();
        },
        cacheDom: function () {
        ...
        bindEvents: function () {
          ...
          (u.handler = function (e) {
            ...
            u.dom.form &&
              (i.on(u.dom.form, "reset", u.handler),
              i.on(u.dom.form, "submit", u.handler));
        },
        unbindEvents: function () {
          ...
          i.off(u.dom.el, "click", u.handler),
            ...
            u.dom.form &&
              (i.off(u.dom.form, "reset", u.handler),
              i.off(u.dom.form, "submit", u.handler)),
            (u.handler = null);
        },
        handleClick: function (u) {
          var e = this,
            ...
            E = "";
          l &&
            (((o = e.mixer.config.selectors.control) && !l.matches(o)) ||
              (u.stopPropagation(),
              t.lastClicked || (t.lastClicked = l),
              ("function" == typeof t.config.callbacks.onMixClick &&
                ((r = t.config.callbacks.onMixClick.call(
                  t.lastClicked,
                  t.state,
                  u,
                  e
                ...
                r === !1)) ||
                (l.matches("[data-filter]")
                  ? ((E = l.getAttribute("data-filter")),
                    (e.activeToggles = []),
                    (e.activeSelectors = e.activeFilters = [E]))
                  : l.matches("[data-toggle]") &&
                    ((E = l.getAttribute("data-toggle")),
                    (e.activeFilters = []),
                    (n = e.activeToggles.indexOf(E)) > -1
                      ? e.activeToggles.splice(n, 1)
                      : e.activeToggles.push(E),
                    "and" === e.logic
                      ? (e.activeSelectors = [e.activeToggles])
                      : (e.activeSelectors = e.activeToggles)),
                e.updateControls(),
                "change" === e.mixer.config.multifilter.parseOn &&
        ...
        handleKeyup: function (u) {
          ...
          if (!(["text", "search", "email"].indexOf(t.type) < 0)) {
            if ("change" !== e.mixer.config.multifilter.parseOn)
              return void e.mixer.getSingleValue(t);
        ...
        handleFormEvent: function (e) {
          ...
          if (
            ...
            "reset" === e.type &&
              ((t.activeFilters = t.activeToggles = t.activeSelectors = []),
              t.updateControls()),
            t.mixer.multifilterFormEventTracker)
          )
            i = t.mixer.multifilterFormEventTracker;
          else
            for (
              i = t.mixer.multifilterFormEventTracker = new u.MultifilterFormEventTracker(),
                i.form = e.target,
                l = 0;
              (r = t.mixer.filterGroups[l]);
              l++
            )
              r.dom.form === e.target && i.totalBound++;
          e.target === i.form &&
            (i.totalHandled++,
            i.totalHandled === i.totalBound &&
              ((t.mixer.multifilterFormEventTracker = null),
              ("submit" !== e.type &&
                "change" !== t.mixer.config.multifilter.parseOn) ||
                t.mixer.parseFilterGroups()));
        },
        getSingleValue: function (u) {
          ...
          if (u.type.match(/text|search|email/g)) {
            if (((r = u.getAttribute("data-search-attribute")), !r))
              throw new Error(
                "[MixItUp MultiFilter] A valid `data-search-attribute` must be present on text inputs"
              );
            if (u.value.length < e.mixer.config.multifilter.minSearchLength)
              return void (e.activeSelectors = e.activeFilters = e.activeToggles = [
                "",
              ]);
          ...
          "string" == typeof u.value &&
            (e.activeSelectors = e.activeToggles = e.activeFilters = l
              ? [l]
              : []);
        },
        ...
        updateControls: function (u) {
          var e = this,
            ...
            o = -1;
          for (
            i = e.mixer.config.selectors.control.trim(),
              r = ["[data-filter]" + i, "[data-toggle]" + i].join(", "),
              u = u || e.dom.el.querySelectorAll(r),
              o = 0;
            (t = u[o]);
            o++
          )
            (l = Boolean(t.getAttribute("data-toggle")) ? "toggle" : "filter"),
              e.updateControl(t, l);
        },
        updateControl: function (u, e) {
          var t = this,
            ...
            o = "";
          (o = i.getClassname(
            t.mixer.config.classNames,
            e,
            t.mixer.config.classNames.modifierActive
          )),
      ...
      u.Mixer.registerAction("afterSanitizeConfig", "multifilter", function () {
        var u = this;
        (u.config.multifilter.logicBetweenGroups = u.config.multifilter.logicBetweenGroups
          .toLowerCase()
          .trim()),
          (u.config.multifilter.logicWithinGroup = u.config.multifilter.logicWithinGroup
            .toLowerCase()
            .trim());
      }),
      ...
      u.Mixer.extend({
        indexFilterGroups: function () {
          ...
          for (r = 0; (i = e.dom.filterGroups[r]); r++)
            if (
              ((t = new u.FilterGroup()),
              t.init(i, e),
              e.filterGroups.push(t),
              t.name)
            ) {
              if ("undefined" != typeof e.filterGroupsHash[t.name])
                throw new Error(
        ...
        parseParseFilterGroupsArgs: function (e) {
          ...
          for (
            ...
            (l = e[o]),
              "boolean" == typeof l
                ? (r.animate = l)
                : "function" == typeof l && (r.callback = l);
          return i.freeze(r), r;
        },
        getFilterGroupPaths: function () {
          ...
          for (E = 0; E < u.filterGroups.length; E++)
            (r = u.filterGroups[E].activeSelectors).length &&
              (l.push(r), n.push(0));
          return (
            (e = function () {
              var u = null,
        ...
        buildSelectorFromPaths: function (u) {
          ...
          if (!u.length) return "";
          if (
            ("or" === e.config.multifilter.logicBetweenGroups && (l = ", "),
            u.length > 1)
          ) {
        ...
        parseFilterGroups: function () {
          var u = this,
            ...
            l = {};
          return (
            "" === i && (i = u.config.controls.toggleDefault),
            (e.command.selector = i),
            (l.filter = e.command),
            "function" == typeof (r = u.config.callbacks.onParseFilterGroups) &&
              (l = r(l)),
        ...
        setFilterGroupSelectors: function (u, e) {
          ...
          if (
            ...
            "undefined" == typeof (i = t.filterGroupsHash[u]))
          )
            throw new Error(
          ...
          (i.activeToggles = e.slice()),
            "and" === i.logic
              ? (i.activeSelectors = [i.activeToggles])
              : (i.activeSelectors = i.activeToggles),
        ...
        getFilterGroupSelectors: function (u) {
          var e = this,
            t = null;
          if ("undefined" == typeof (t = e.filterGroupsHash[u]))
            throw new Error(
              '[MixItUp MultiFilter] No filter group could be found with the name "' +
                u +
                '"'
  ...
  if (
    ((e.TYPE = "mixitup-extension"),
    (e.NAME = "mixitup-multifilter"),
    (e.EXTENSION_VERSION = "3.3.6"),
    (e.REQUIRE_CORE_VERSION = "^3.1.2"),
    ...
    if (!u.mixitup || "function" != typeof u.mixitup)
